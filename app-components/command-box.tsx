...
const otherItems = [
    { icon: <Github />, title: "Go to Code", description: "Navigate to the source code.", link: "https://github.com/Aryan972/portfolio" },
    { icon: <Linkedin />, title: "Go to LinkedIn", description: "Navigate to my LinkedIn profile.", link: "https://www.linkedin.com/in/abhishek-nigam-8a5643190/" },
